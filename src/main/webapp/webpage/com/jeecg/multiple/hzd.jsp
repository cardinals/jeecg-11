    ...
    <script>
        function fn_print(param) {
            ...
            if(param=="hz_div_zs"){
                ...
                document.body.innerHTML=html;
                window.print();
            }else if(param=="hz_div_jj"){
                var html = document.getElementById("hz_div_jj").innerHTML;
                document.body.innerHTML=html;
                window.print();
            }
...
<div align="center" id="hz_div" style="margin-top: 10px;">
    <div  style="width: 600px;" id="hz_div_zs" class="item-sel" title="预受理回执单（申请人）">
        ...
        <div style="text-align:right;margin:0;padding:0;height:20px;width: 600px; ">
            业务号：
            <span >${bProjectBusinessPage.businessId}</span>
        </div>
    ...
    <div align="center" style="width: 600px;" id="hz_div_jj" class="print_page_break_ba item-sel" title="材料交接单">
        <div align="center">
            <div style="width: 100%;">
                <div>
                    <strong><font style="font-size:20px;" class="systitle">郑东新区建设项目并联审批监管系统</font></strong>
            ...
            <table width="600" border="1">
                ...
                <tr>
                    ...
                    <td height="76" colspan="3" valign="bottom">
                        预受理 ________________________<br/>
                        材料接收人 ________________________
                    </td>
                </tr>
                </tbody>
            </table>
    ...
    <div style="text-align: center; margin-top: 5px;">
        <a href='javascript:void(0)' onclick="fn_print('hz_div_jj');" style="background: #6ddae0;font-size: 13px;padding: 2px 8px 3px 8px;">打印</a>
    </div>
