...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="bChildBusinessList" pagination="true" fitColumns="true" title="子项业务统计" actionUrl="bChildBusinessController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="子业务流水号"  field="childBusinessId"  query="true" width="60"></t:dgCol>
   <t:dgCol title="项目编号"  field="projectId"  hidden="true"  queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="阶段编号"  field="phasesId"  funname="phaseName(phasesId)"  queryMode="group"  width="40"></t:dgCol>
