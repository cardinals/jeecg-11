...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="bChildBusinessList" pagination="true" fitColumns="true" title="子项业务统计" actionUrl="bChildBusinessController.do?datagrid" idField="id" fit="true" queryMode="group">
   <t:dgCol title="id"  field="id"  hidden="true"  queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="项目名称"  field="realityProjectName" query="true"  width="80"></t:dgCol>
   <t:dgCol title="业务流水号"  field="businessId" hidden="true" query="true" width="120"></t:dgCol>
   ...
   <t:dgCol title="阶段编号"  field="phasesId"  funname="phaseName(phasesId)"  queryMode="group"  width="90"></t:dgCol>
   ...
   <t:dgCol title="部门编号"  field="deptId"  hidden="true"  queryMode="group"  width="80"></t:dgCol>
   ...
   <t:dgCol title="申请时间"  field="applyTime"  formatter="yyyy-MM-dd"  queryMode="group"  width="60"></t:dgCol>
   <t:dgCol title="所剩时限"  field="ssgzr"  queryMode="group"  width="40"></t:dgCol>
   <t:dgCol title="业务状态"  field="status"  queryMode="group" replace="在办_0,办结_1,作废_2,补交挂起_3,特别程序_4,暂存_5,已归档_6" width="40"></t:dgCol>
