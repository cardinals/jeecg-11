...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="bChildBusinessList" pagination="true" fitColumns="true" title="时限监控" actionUrl="bChildBusinessController.do?limitDatagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="并联业务流水号"  field="businessId" hidden="true" width="120"></t:dgCol>
   <t:dgCol title="子业务流水号"  field="childBusinessId"  query="true" width="90"></t:dgCol>
   ...
   <t:dgCol title="事项编号"  field="itemsId"  hidden="true"  queryMode="group"  width="80"></t:dgCol>
   <t:dgCol title="事项名称"  field="itemsName" query="true"  width="100"></t:dgCol>
   ...
   <t:dgCol title="申请时间"  field="applyTime" hidden="true"  formatter="yyyy-MM-dd"  queryMode="group"  width="120"></t:dgCol>
   ...
   <t:dgCol title="上传时间"  field="confirmUploadTime"  formatter="yyyy-MM-dd hh:mm:ss" queryMode="group"  width="70"></t:dgCol>
   <t:dgCol title="预审时间"  field="checkTime"  formatter="yyyy-MM-dd hh:mm:ss" queryMode="group"  width="70"></t:dgCol>
   <t:dgCol title="预审状态"  field="checkStatus"  queryMode="group"  width="35" replace="退回_0,通过_1"></t:dgCol>

   <t:dgCol title="监控状态"  field="jcstatus"   query="true" width="35" extendParams="styler:fmtype" replace="正常_正常,超期_超期"></t:dgCol>
...
<%--
 ...
 function fmtype(val,row,index){
     //可添加更多CSS样式
     var s1 = 'background-color:#21B9BB;color:#FFF;';
     var s2 = 'background-color:red;color:#FFF;';
