...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="bChildBusinessList" pagination="true" fitColumns="true" title="时限监控" actionUrl="bChildBusinessController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="子业务流水号"  field="childBusinessId"  query="true" width="80"></t:dgCol>
