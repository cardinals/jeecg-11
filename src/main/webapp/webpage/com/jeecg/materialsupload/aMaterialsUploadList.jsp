...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="aMaterialsUploadList"   pagination="true" fitColumns="true" title="材料上传信息" actionUrl="aMaterialsUploadController.do?datagrid" idField="id" fit="true" queryMode="group">
