...
@Service("aMaterialsInfoService")
@Transactional
public class AMaterialsInfoServiceImpl extends CommonServiceImpl implements AMaterialsInfoServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(AMaterialsInfoEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(AMaterialsInfoEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(AMaterialsInfoEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(AMaterialsInfoEntity t){
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("id", t.getId());
		map.put("materials_id", t.getMaterialsId());
		map.put("materials_name", t.getMaterialsName());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,AMaterialsInfoEntity t){
 		sql  = sql.replace("#{id}",String.valueOf(t.getId()));
 		sql  = sql.replace("#{materials_id}",String.valueOf(t.getMaterialsId()));
 		sql  = sql.replace("#{materials_name}",String.valueOf(t.getMaterialsName()));
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("a_materials_info",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
